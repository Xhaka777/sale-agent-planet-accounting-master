...
public class Preferences {
    ...
    //Pjesa per AboutPage
    public static String PHONE_COMP = "NUMRI_KOMPANIS";
    public static String SALES_COMP = "SALE_KOMPANIA";
    public static String HELP_COMP = "HELP_KOMPANIA";
    ...
    public boolean getPhoneComp(){
        return userPreferences.getBoolean(PHONE_COMP, true);
    }

    public void setPhoneComp(boolean phoneComp){
        userPreferences.edit().putBoolean(PHONE_COMP, phoneComp).commit();
    }

    public boolean getSalesComp(){
        return userPreferences.getBoolean(SALES_COMP, true);
    }

    public void setSalesComp(boolean salesComp){
        userPreferences.edit().putBoolean(SALES_COMP, salesComp).commit();
    }

    public boolean getHelpComp(){
        return userPreferences.getBoolean(HELP_COMP, true);
    }

    public void setHelpComp(boolean helpComp){
        userPreferences.edit().putBoolean(HELP_COMP, helpComp).commit();
    }
}
